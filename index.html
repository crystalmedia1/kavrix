...
<head>
    ...
    <style>
        ...
        .preview-container { height: calc(100vh - 160px); border-radius: 32px; overflow: hidden; background: #161b2a; position: relative; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); }
...
<body class="flex h-screen">
    ...
    <aside id="mainSidebar" class="sidebar glass h-full flex flex-col p-6 z-50">
        ...
        <div class="mt-4 p-3 glass rounded-xl flex justify-around">
            <button onclick="setTheme('midnight')" class="w-6 h-6 rounded-full bg-slate-800 border border-white/20"></button>
            <button onclick="setTheme('cyberpunk')" class="w-6 h-6 rounded-full bg-fuchsia-600 border border-white/20"></button>
            <button onclick="setTheme('emerald')" class="w-6 h-6 rounded-full bg-emerald-600 border border-white/20"></button>
        </div>
    ...
    <main class="flex-1 flex flex-col p-6 relative">
        ...
        <!-- PREVIEW AREA -->
        <div class="preview-container glass relative">
        ...
        <!-- INPUT AREA -->
        <div class="mt-6 max-w-3xl mx-auto w-full">
    ...
    <script>
        const API_URL = "https://kavrix.onrender.com"; // JOUW RENDER URL
